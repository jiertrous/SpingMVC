...
<script type="text/javascript">
	//id，商品id  num更改后的数据  pnum就是库存
	function changNum(id,num,pnum){
	//	alert(id + "-" + num + "-" + pnum);
		//购买的数量不能大于库存
		if(num > pnum){
			alert('购买的数量不能大于库存');
									...
									<tr>
										<td>
											<table cellspacing="1" class="carttable">
												...
												<c:forEach items="${cart}" var="entry" varStatus="vs"><!-- entry 为商品 -->
													<tr>
														...
														<td width="20%">
														<input type="button" value='-' style="width:20px" onclick="changNum(${entry.key.id},${entry.value -1},${entry.key.pnum})">
