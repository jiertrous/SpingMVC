...
<script type="text/javascript">
	...
	function deleteProduct(productName ,productId) {
		//确认提示框
		if(confirm('是否要删除【'+ productName +'】这本书？')){
			//确定  要删除
			location.href = '${pageContext.request.contextPath}/deletebook?id=' + productId;
...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/searchbook" method="post">
							...
							<c:forEach items='${products}' var="product">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/findbook?id=${product.id}">
									...
									<%-- <a       无提示
										href="${pageContext.request.contextPath}/deletebook?id=${product.id}">
